function log_prob_sig = compute_log_likelihood_sig(prms,stim,z_hidden)
...
log_prob_sig = log(1.0/prms.sigma_stim^(prms.pix*prms.pix)) - ((1.0/(2.0*prms.sigma_stim^2)) * norm(stim(:) - prms.G*z_hidden(:))^2); 
